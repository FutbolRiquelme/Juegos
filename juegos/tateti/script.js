...
// --- NUEVAS LISTAS DE CLASIFICACIÓN ---

// Lista de equipos
const listaEquipos = [
    "Real Madrid", "Barcelona", "PSG", "Manchester City", 
    "Juventus", "Manchester United", "Bayern Munich", "Milan", 
    "Boca", "River", "Inter", "Napoli", "Santos"
];

// Lista de países/nacionalidades (Agregué todos los que tenés en tu base de datos por las dudas)
const listaPaises = [
    "Argentino", "Brasil", "Español", "Francia", "Uruguay", 
    "Italiano", "Croata", "Noruega", "Bélgica", "Alemania", 
    "Polonia", "Portugués"
];
...
function generarRutaImagen(categoria) {
    // Normalizamos el nombre del archivo (ej: "Ganó Mundial" -> "ganomundial.png")
